...
BOOL CALLBACK DlgProc(HWND wnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
   ...
   case WM_COMMAND:
      ...
      case IDC_ADD:
      {
         ...
         // they entered
         BOOL bSuccess;
         int  nTimes = GetDlgItemInt(wnd, IDC_NUMBER, &bSuccess, FALSE);
         ...
         if ( bSuccess )
         {
            ...
            if ( len > 0 )
            {
               ...
               for ( i = 0; i < nTimes; i++ )
               {
                  ...
                  // as a pointer.
                  SendDlgItemMessageW(wnd, IDC_LIST, LB_SETITEMDATA, (WPARAM) index, (LPARAM) nTimes);
               }
      ...
      case IDC_REMOVE:
      {
         ...
         // of selected items
         HWND hList = GetDlgItem(wnd, IDC_LIST);
...
int WINAPI wWinMain(_In_     HINSTANCE inst,
                    ...
                    _In_     int       cmdShow)
{
   return (int) DialogBoxW(inst, MAKEINTRESOURCE(IDD_MAIN), NULL, (DLGPROC) DlgProc);
}
